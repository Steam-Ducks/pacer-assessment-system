...
public class GerenciarSemestreController {
    ...
    public void adicionarSemestre() {
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/SistemaRecap/Semestre/cadastrarSemestreView.fxml"));
    ...
    public void abrirTelaEdicao() {
        ...
        if (semestreSelecionado != null) {
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/SistemaRecap/Semestre/editarSemestreView.fxml"));
